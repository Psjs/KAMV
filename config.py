...
class HParameters:
    ...
    def __init__(self):
        ...
        #self.lr_epochs = [0]
        #self.lr = [0.00005]
        #self.lr = [0.001] #0.60805
        #self.lr = [0.005],self.l2_req = 0.001 #0.61228, 0.65179, 0.57841, 0.62145, 0.5888
                                                #0.63323，0.66613，0.62854，0.66046，0.60226

        #self.lr = [0.005] ,self.l2_req = 0.0005 #0.60083,0.65077,0.57203,0.62433,0.5899

        #self.lr = [0.007],self.l2_req=0.001  #0.60698,0.63924,0.56616,0.62495

        #self.lr = [0.005]
        self.lr = [0.0005]

        self.epochs_max = 1500
        ...
        self.splits += ['splits/tvsum_aug_splits.json',
                       'splits/summe_aug_splits.json',
                        'splits/tvsum_trans_splits.json',
                        'splits/summe_trans_splits.json']
